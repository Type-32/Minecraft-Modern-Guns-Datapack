particle dust 1 1 1 0.13 ~ ~ ~ 0 0 0 0.1 1 force
...
execute if score .dist shoot_dist matches ..130 positioned ^ ^ ^1 if block ~ ~ ~ #vng:penetrable run function vng:rays/cbt97
