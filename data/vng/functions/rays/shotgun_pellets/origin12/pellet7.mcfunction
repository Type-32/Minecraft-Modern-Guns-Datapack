...
execute positioned ^ ^.05 ^1 unless block ~ ~ ~ #vng:penetrable run playsound vng:common.solid_bullet_impact block @a[distance=..11] ~ ~ ~ 10
execute positioned ^ ^.05 ^1 run function vng:func/ray_reset
execute positioned ^ ^.05 ^1 if block ~ ~ ~ #vng:penetrable run function vng:rays/shotgun_pellets/origin12/pellet7
