...
execute positioned ^ ^ ^1 unless block ~ ~ ~ #vng:penetrable run particle minecraft:crit ~ ~ ~ .01 .01 .01 1.8 5 force
...
execute positioned ^-.03 ^ ^1 if block ~ ~ ~ #vng:penetrable run function vng:rays/shotgun_pellets/origin12/pellet2
