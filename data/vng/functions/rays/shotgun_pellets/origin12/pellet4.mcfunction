...
execute positioned ^ ^-.04 ^1 unless block ~ ~ ~ #vng:penetrable run particle minecraft:crit ~ ~ ~ .01 .01 .01 1.8 5 force
execute positioned ^ ^-.04 ^1 unless block ~ ~ ~ #vng:penetrable run playsound vng:common.solid_bullet_impact block @a[distance=..11] ~ ~ ~ 10
execute positioned ^ ^-.04 ^1 run function vng:func/ray_reset
execute positioned ^ ^-.04 ^1 if block ~ ~ ~ #vng:penetrable run function vng:rays/shotgun_pellets/origin12/pellet4
