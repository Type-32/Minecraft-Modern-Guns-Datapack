item modify entity @s[predicate=vng:is_sneaking,scores={aimSec=2..},tag=!haveRedDot,tag=!haveHolo,tag=!haveSupressor,tag=!haveGrip] weapon.mainhand vng:cbr27/cbr27_aiming
...
item modify entity @s[predicate=!vng:is_sneaking,predicate=!vng:is_sprinting,tag=!haveRedDot,tag=!haveHolo,tag=!haveSupressor,tag=!haveGrip] weapon.mainhand vng:cbr27/cbr27
