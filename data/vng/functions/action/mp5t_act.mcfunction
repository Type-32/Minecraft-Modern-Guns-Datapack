...
execute anchored eyes run function vng:rays/mp5t
tag @s remove firing
...
execute as @s run playsound vng:mp5t.fire voice @a[distance=..30] ~ ~ ~ 10
...
execute if score @s mp5t.ammo matches ..0 at @s run playsound vng:common.empty player @s
