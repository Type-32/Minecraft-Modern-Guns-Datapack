execute if entity @s[tag=!haveGrip,tag=!haveSupressor,tag=!haveRedDot,tag=!haveHolo] run function vng:equip/cbr27/func/atch_sup
execute if entity @s[tag=haveGrip,tag=!haveSupressor,tag=!haveRedDot,tag=!haveHolo] run function vng:equip/cbr27/func/atch_grip_sup
