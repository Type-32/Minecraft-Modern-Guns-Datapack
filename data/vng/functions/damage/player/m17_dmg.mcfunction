...
scoreboard players set @a[tag=firingMarkerDetect,tag=holdingM17] whiteHit 0
playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,tag=holdingM17] ~ ~1000 ~ 1000000000 2
