...
scoreboard players set @a[tag=firingMarkerDetect,tag=holdingMP5T] whiteHit 0
playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,tag=holdingMP5T] ~ ~1000 ~ 1000000000 2
