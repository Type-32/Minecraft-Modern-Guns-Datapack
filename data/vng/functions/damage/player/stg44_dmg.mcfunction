...
scoreboard players set @a[tag=firingMarkerDetect,tag=holdingSTG44] whiteHit 0
playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,tag=holdingSTG44] ~ ~1000 ~ 1000000000 2
