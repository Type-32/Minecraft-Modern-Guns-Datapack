...
scoreboard players set @a[tag=firingMarkerDetect,tag=holdingMP40] whiteHit 0
playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,tag=holdingMP40] ~ ~1000 ~ 1000000000 2
