...
scoreboard players set @s[tag=!WitherenVest,tag=!CombatMasterVest] hp_dmg 20
scoreboard players set @s[tag=WitherenVest] hp_dmg 19
scoreboard players set @s[tag=CombatMasterVest] hp_dmg 18
