...
scoreboard players set @a[tag=firingMarkerDetect,tag=holdingMP5] whiteHit 0
playsound minecraft:ui.button.click voice @a[tag=firingMarkerDetect,tag=holdingMP5] ~ ~1000 ~ 1000000000 2
